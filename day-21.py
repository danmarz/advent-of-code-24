...
def build_sequence_of_shortest_paths(seq, keypad):
    ...
    for key1, key2 in zip("A" + seq, seq):
        res += [
            [sp + "A" for sp in build_shortest_paths_between_keys(key1, key2, keypad)]
        ]
    return res
...
# Credits go to https://www.reddit.com/r/adventofcode/comments/1hj2odw/comment/m34rqwh/ for this elegant solution :)
